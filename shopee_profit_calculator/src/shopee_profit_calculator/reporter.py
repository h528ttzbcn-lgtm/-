...
def _row(r: ProfitResult) -> dict:
    return {
        ...
        "export_tax_refund": round(r.export_tax_refund, 2),
        ...
        "target_margin_rate_pct": round(r.target_margin_rate * 100, 2) if r.target_margin_rate is not None else "",
        "recommended_price": round(r.recommended_price, 2) if r.recommended_price is not None else "",
        "price_diff": round(r.price_diff, 2) if r.price_diff is not None else "",
