...
- **古物商許可**:古物営業法では、未使用品でも「一度、使用のために取引されたもの」は古物に当たります。
  そのため、量販店などの**小売店から消費者として買った新品を転売する場合も、古物商許可が必要と案内されるのが一般的**です
  (メーカー・問屋から直接仕入れる場合は通常対象外です)。仕入れを始める前に、管轄の警察署(生活安全課)で確認してください。
- 楽天市場・Yahoo!ショッピングの出品者は法人・個人事業主のストアだけです(フリマのように個人から買うことはありません)。
  ただし、真贋調査では、**Amazonがブランドによっては小売店の領収書を仕入れの証明と認めない**ことがあります。
  出品制限のあるブランドは避けるのが無難です。
...
- Amazonの「新品」は、**メーカーの保証が有効で、元のパッケージのまま未開封**である必要があります。
  中古市場で流通する「未使用品」(中古品扱いの未開封品)は、ストアが販売していても新品として出品できないため、除外対象にしています。
